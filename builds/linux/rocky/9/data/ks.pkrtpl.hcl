...
logvol / --fstype ext4 --name=lv_root --vgname=sysvg --size=6144 --label=ROOTFS
logvol /home --fstype ext4 --name=lv_home --vgname=sysvg --size=4096 --label=HOMEFS --fsoptions="nodev,nosuid"
logvol /opt --fstype ext4 --name=lv_opt --vgname=sysvg --size=2048 --label=OPTFS --fsoptions="nodev"
logvol /tmp --fstype ext4 --name=lv_tmp --vgname=sysvg --size=1024 --label=TMPFS --fsoptions="nodev,noexec,nosuid"
logvol /var --fstype ext4 --name=lv_var --vgname=sysvg --size=8192 --label=VARFS --fsoptions="nodev" --grow
logvol /var/log --fstype ext4 --name=lv_log --vgname=sysvg --size=4096 --label=LOGFS --fsoptions="nodev,noexec,nosuid"
logvol /var/log/audit --fstype ext4 --name=lv_audit --vgname=sysvg --size=1024 --label=AUDITFS --fsoptions="nodev,noexec,nosuid"
logvol /var/lib/longhorn --fstype ext4 --name=lv_longhorn --vgname=sysvg --percent=33 --label=LONGHORN --fsoptions="nodev,nosuid"
